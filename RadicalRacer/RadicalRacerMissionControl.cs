...
namespace RadicalRacer
{
    ...
    public class RadicalRacerMissionControl : Microsoft.Xna.Framework.Game
    {
        ...
        // Video splash removed - not well supported in MonoGame DesktopGL
        ...
        protected override void LoadContent()
        {
            ...
            // Video removed - not well supported in MonoGame DesktopGL
        ...
        private void DrawGameMainMenu()
        {
            ...
            // Video removed - use start screen image instead
           ...
           GraphicsDevice.Viewport.Height);
            ...
            spriteBatch.Draw(startScreenImage, screen, Color.White);
